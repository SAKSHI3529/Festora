...
const FacultyApprovalsList = () => {
    ...
    return (
        <Container fluid>
            <div className="mb-4">
                <h4 className="fw-bold mb-1">📋 Registration Approvals</h4>
                <p className="text-muted small">Select an event to manage pending registrations and teams.</p>
            </div>
            ...
            {events.length === 0 ? (
                <Card className="border-0 shadow-sm text-center py-5">
                    <Card.Body>
                        ...
                        <p className="text-muted small">You don't have any events assigned for registration management.</p>
                    </Card.Body>
                </Card>
            ) : (
                <Row className="g-3">
                            ...
                            <Card className="border-0 shadow-sm h-100" style={{ borderRadius: 12 }}>
                                <Card.Body className="d-flex flex-column">
                                    <div className="d-flex justify-content-between align-items-start mb-2">
                                        ...
                                        <Badge bg={event.status === 'COMPLETED' ? 'secondary' : 'primary'}>
                                            {event.status}
                                        </Badge>
                                    </div>
...
export default FacultyApprovalsList;
