...
const MENU_CONFIG = {
    ...
    faculty: [
        { title: 'Main', type: 'heading' },
        { label: 'Dashboard',      icon: 'mdi-view-dashboard',    path: '/dashboard' },
        { title: 'Event Control', type: 'heading' },
        { label: 'My Events',      icon: 'mdi-calendar-check',    path: '/faculty/dashboard' },
        { label: 'Approvals',      icon: 'mdi-account-check',    path: '/faculty/approvals' },
        { label: 'Attendance',     icon: 'mdi-calendar-clock',    path: '/faculty/attendance' },
        { label: 'Event Status',   icon: 'mdi-list-status',       path: '/faculty/status' },
    ...
    student: [
        ...
        { label: 'Event Results',    icon: 'mdi-trophy-outline',     path: '/student/results' },
